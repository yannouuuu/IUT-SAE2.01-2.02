...
public class AdolescentTest {
    ...
    void testHistoryCompatibilityOk() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(), LocalDate.now());
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(), LocalDate.now());
        ...
        Adolescent host2 = new Adolescent("Host", "B", "male", "France", Map.of(Criteres.HISTORY, "same"), LocalDate.now());
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.HISTORY, "same"), LocalDate.now());
        ...
        Adolescent host3 = new Adolescent("Host", "C", "male", "France", Map.of(Criteres.HISTORY, "same"), LocalDate.now());
        Adolescent visitor3 = new Adolescent("Visitor", "Z", "female", "Italia", Map.of(), LocalDate.now());
    ...
    void testHistoryIncompatibility() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HISTORY, "other"), LocalDate.now());
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(), LocalDate.now());
        ...
        Adolescent host2 = new Adolescent("Host", "B", "male", "France", Map.of(), LocalDate.now());
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.HISTORY, "other"), LocalDate.now());
        ...
        Adolescent host3 = new Adolescent("Host", "C", "male", "France", Map.of(Criteres.HISTORY, "other"), LocalDate.now());
        Adolescent visitor3 = new Adolescent("Visitor", "Z", "female", "Italia", Map.of(Criteres.HISTORY, "other"), LocalDate.now());
    ...
    void testHistoryAffinityBonus() {
        ...
        Adolescent hostNoHistory = new Adolescent("Host", "A", "male", "France", 
    ...
    void testGlobalCompatibilityOk() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "no", Criteres.HOST_FOOD, "vegetarian"), LocalDate.now());
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes", Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now());
    ...
    void testGlobalIncompatibilityAllergy() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "yes", Criteres.HOST_FOOD, "vegetarian"), LocalDate.now());
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes", Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now());
    ...
    void testGlobalIncompatibilityDiet() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "no", Criteres.HOST_FOOD, "nonuts"), LocalDate.now());
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes", Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now());
    ...
    void testAffinityGenderPreference() {
        ...
        Adolescent host = new Adolescent("Host", "B", "male", "France", 
            Map.of(Criteres.HOST_HAS_ANIMAL, "no", 
                   Criteres.HOST_FOOD, "vegetarian", 
