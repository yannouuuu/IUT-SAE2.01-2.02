...
public class AdolescentTest {
    ...
    void testAllergiesCompatibility() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "no"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes"), LocalDate.now(),false);
        ...
        Adolescent host2 = new Adolescent("Host", "B", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "yes"), LocalDate.now(),true);
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "no"), LocalDate.now(),false);
        ...
        Adolescent host3 = new Adolescent("Host", "C", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "no"), LocalDate.now(),true);
        Adolescent visitor3 = new Adolescent("Visitor", "Z", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "no"), LocalDate.now(),false);
        ...
        Adolescent host4 = new Adolescent("Host", "D", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "no"), LocalDate.now(),true);
        ...
        Adolescent visitor5 = new Adolescent("Visitor", "V", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes"), LocalDate.now(),false);
    ...
    void testAllergiesIncompatibility() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HOST_HAS_ANIMAL, "yes"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes"), LocalDate.now(),false);
    ...
    void testDietCompatibilityOk() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HOST_FOOD, "vegetarian, nonuts"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now(),false);
        ...
        Adolescent host2 = new Adolescent("Host", "B", "male", "France", Map.of(Criteres.HOST_FOOD, "vegetarian, nonuts"), LocalDate.now(),true);
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.GUEST_FOOD, "nonuts, vegetarian"), LocalDate.now(),false);
        ...
        Adolescent host3 = new Adolescent("Host", "C", "male", "France", Map.of(Criteres.HOST_FOOD, "vegetarian, nonuts"), LocalDate.now(),true);
        Adolescent visitor3 = new Adolescent("Visitor", "Z", "female", "Italia", Map.of(Criteres.GUEST_FOOD, "nonuts"), LocalDate.now(),false);
    ...
    void testDietIncompatibility() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HOST_FOOD, "vegetarian"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_FOOD, "nonuts"), LocalDate.now(),false);
        ...
        Adolescent host2 = new Adolescent("Host", "B", "male", "France", Map.of(Criteres.HOST_FOOD, "vegetarian"), LocalDate.now(),true);
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.GUEST_FOOD, "vegetarian, nonuts"), LocalDate.now(),false);
    ...
    void testDietCompatibilityHostOffersNothing() {
        ...
        Adolescent host2 = new Adolescent("Host", "B", "male", "France", Map.of(Criteres.HOST_FOOD, ""), LocalDate.now(),true);
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now(),false);
        ...
        Adolescent visitor3 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.GUEST_FOOD, "vegetarian, nonuts"), LocalDate.now(),false);
    ...
    void testHistoryCompatibilityOk() {
        ...
        Adolescent host2 = new Adolescent("Host", "B", "male", "France", Map.of(Criteres.HISTORY, "same"), LocalDate.now(),true);
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.HISTORY, "same"), LocalDate.now(),false);
        ...
        Adolescent host3 = new Adolescent("Host", "C", "male", "France", Map.of(Criteres.HISTORY, "same"), LocalDate.now(),true);
    ...
    void testHistoryIncompatibility() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "France", Map.of(Criteres.HISTORY, "other"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(), LocalDate.now(),false);
        ...
        Adolescent visitor2 = new Adolescent("Visitor", "Y", "female", "Italia", Map.of(Criteres.HISTORY, "other"), LocalDate.now(),false);
        ...
        Adolescent host3 = new Adolescent("Host", "C", "male", "France", Map.of(Criteres.HISTORY, "other"), LocalDate.now(),true);
        Adolescent visitor3 = new Adolescent("Visitor", "Z", "female", "Italia", Map.of(Criteres.HISTORY, "other"), LocalDate.now(),false);
    ...
    void testFrenchCompatibility() {
        ...
        Adolescent host = new Adolescent("Host", "A", "male", "France", 
            Map.of(Criteres.HOST_HAS_ANIMAL, "no", 
                   ...
                   Criteres.HOBBIES, "football,reading,gaming"), 
        ...
        Adolescent visitor = new Adolescent("Visitor", "X", "female", "Italia", 
            Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "no", 
                   Criteres.HOBBIES, "dance,gaming,vocaloid"), 
    ...
    void testFrenchIncompatibility() {
        ...
        Adolescent host = new Adolescent("Host", "A", "male", "France", 
            Map.of(Criteres.HOST_HAS_ANIMAL, "no", 
                   Criteres.HOBBIES, "football,swimming,Streaming"), 
            LocalDate.of(2008, 5, 15),true);
    ...
    void testGlobalCompatibilityOk() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "Italia", Map.of(Criteres.HOST_HAS_ANIMAL, "no", Criteres.HOST_FOOD, "vegetarian"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes", Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now(),false);
    ...
    void testGlobalIncompatibilityAllergy() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "Belgium", Map.of(Criteres.HOST_HAS_ANIMAL, "yes", Criteres.HOST_FOOD, "vegetarian"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes", Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now(),false);
    ...
    void testGlobalIncompatibilityDiet() {
        ...
        Adolescent host1 = new Adolescent("Host", "A", "male", "Italia", Map.of(Criteres.HOST_HAS_ANIMAL, "no", Criteres.HOST_FOOD, "nonuts"), LocalDate.now(),true);
        Adolescent visitor1 = new Adolescent("Visitor", "X", "female", "Italia", Map.of(Criteres.GUEST_ANIMAL_ALLERGY, "yes", Criteres.GUEST_FOOD, "vegetarian"), LocalDate.now(),false);
